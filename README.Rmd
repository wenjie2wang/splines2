...
In addition to the R interface, **splines2** also provides a C++ head-only
...
can also be treated as a **Rcpp**\* package (similar to **RcppArmadillo**,
**RcppEigen**, or **RcppNumerical**, etc.)

...
The package **splines2** is designed to be a complementary package on splines.
...
and M-splines. Also, it provides a more user-friendly interface, more consistent
handling on `NA`'s for derivatives.

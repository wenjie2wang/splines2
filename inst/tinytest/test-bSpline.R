...
expect_equal(isNumMatrix(bsMat0a, 14L, 1L), TRUE)
expect_equal(sum(is.na(bsMat0b)), 15L) # keep NA's as is
expect_equal(isNumMatrix(bsMat0b, 14L, 5L), TRUE)
expect_equal(isNumMatrix(bsMat0c, 14L, 5L), TRUE)
expect_equal(isNumMatrix(bsMat0d, 14L, 3L), TRUE)
expect_equal(isNumMatrix(bsMat0e, 14L, 4L), TRUE)
